...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/samuelokuneye/metric-server.git  and run the commands below:
 
```console
# clone manifest repo
git clone https://github.com/samuelokuneye/metric-server
# deploy metricAPI
